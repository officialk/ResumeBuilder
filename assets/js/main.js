!(function (o) {
  ...
  o(document).on("click", ".nav-menu a, .scrollto", function (t) {
    if (
      ...
      if (e.length) {
        ...
        return (
          ...
          o(this).parents(".nav-menu, .mobile-nav").length &&
            (o(".nav-menu .active, .mobile-nav .active").removeClass("active"),
            o(this).closest("li").addClass("active")),
          o("body").hasClass("mobile-nav-active") &&
            (o("body").removeClass("mobile-nav-active"),
            o(".mobile-nav-toggle i").toggleClass(
    ...
    o(document).on("click", ".mobile-nav-toggle", function (t) {
      o("body").toggleClass("mobile-nav-active"),
        o(".mobile-nav-toggle i").toggleClass(
          "icofont-navigation-menu icofont-close"
        );
    }),
  ...
  o(window).on("scroll", function () {
    ...
    o('[data-toggle="counter-up"]').counterUp({ delay: 10, time: 1e3 }),
    o(".skills-content").waypoint(
      function () {
    ...
    o(window).on("load", function () {
      var t = o(".portfolio-container").isotope({
        itemSelector: ".portfolio-item",
        layoutMode: "fitRows",
      });
      o("#portfolio-flters li").on("click", function () {
        o("#portfolio-flters li").removeClass("filter-active"),
          o(this).addClass("filter-active"),
          t.isotope({ filter: o(this).data("filter") }),
          a();
      }),
        o(document).ready(function () {
          o(".venobox").venobox();
    ...
    o(".testimonials-carousel").owlCarousel({
      autoplay: !0,
      dots: !0,
      loop: !0,
